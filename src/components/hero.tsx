...
export default function Hero() {
  ...
  return (
    <section className="flex flex-col lg:flex-row items-center justify-center bg-background text-foreground w-full max-w-5xl mx-auto gap-16 px-12 py-16 lg:mt-8">
